...
require_once('includes/load.php');
	...
	if (isset($_GET['id_factura']))
	{
		...
		$sql_factura=mysqli_query($cone,"select $campos from facturas, clientes where facturas.id_cliente=clientes.id_cliente and id_factura='".$id_factura."'");
		
		$count=$db->num_rows($sql_factura);
		if ($count==1)
		{
  ...
  <body>
	...
	<div class="panel panel-info">
		...
		<?php 
			...
			include("model/registro_clientes.php");
			include("model/registro_productos.php");
		?>
						...
						<div class="form-group row">
							...
							<div class="col-md-3">
								<select class="form-control input-sm" id="id_vendedor" name="id_vendedor">
									<?php
									//$sql_vendedor=find_all('users');	
									$sql_vendedor=mysqli_query($cone,"select * from users order by name");
