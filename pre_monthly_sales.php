...
<form name="form1" method="post" action="monthly_sales.php">
<div class="col-md-6">
...
<form name="form2" method="post" action="monthly_sales_usuario.php">
<div class="col-md-6">
...
date_default_timezone_set('America/Lima');
 ...
 $sales =  monthlySalesByUser($year,$month,$_SESSION['user_id']);
